...
#%%
counts = pd.read_csv('networks/synthetic_small/t_test_counts100.csv', header=None)
time = pd.read_csv('networks/synthetic_small/t_test_time100.csv', header=None)
